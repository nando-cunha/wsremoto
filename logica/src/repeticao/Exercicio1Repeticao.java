...
public class Exercicio1Repeticao {
	...
	public static void main(String[] args) {
		...
		String mes = JOptionPane.showInputDialog("Digite o mês").toLowerCase();
		while(mes.contains("janeiro"+"fevereiro"+"março"+"maio"+"abril"+"junho"+"julho"+"agosto"+"setembro"+"outubro"+"novembro"+"dezembro")==true)
		{
			System.out.println("Mês inexistente");
			mes = JOptionPane.showInputDialog("Digite o mês").toLowerCase();
		}
