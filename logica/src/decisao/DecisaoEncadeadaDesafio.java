...
public class DecisaoEncadeadaDesafio {
	...
	public static void main(String[] args) {
		...
		String tipo = JOptionPane.showInputDialog("Informe o Tipo (Eletrônico ou Alimenticio): ").toUpperCase();
		int qtd = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade comprada: "));
		double valor_unit = Double.parseDouble(JOptionPane.showInputDialog("Informe o valor unitário do produto: "));
		
		if (qtd>100 && tipo.equals("ALIMENTICIO") )
		{
			double valor_com_imposto = valor_unit + 4.0;
			System.out.println("O valor unitário será de: " + valor_com_imposto + " r$");
		}
		...
		{
		System.out.println("Categoria Inválida ou não cadastrada.");
		}
	}
